...
import { CmsComponentData, ICON_TYPE, SearchBoxComponentService, SearchBoxConfig, SearchBoxProductSelectedEvent, SearchBoxSuggestionSelectedEvent, SearchResults } from '@spartacus/storefront';
